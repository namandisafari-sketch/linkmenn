        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-10 max-w-lg">
              At Marvid Pharmacy Limited, we're dedicated to advancing public health by providing affordable, high-quality medicines, with a special focus on combating malaria. We partner with global health leaders to ensure reliable supply chains and effective healthcare solutions across Uganda and East Africa.
            </p>
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <img src={pharmacyImg} alt="Marvid Pharmacy interior" className="w-full h-[400px] md:h-[480px] object-cover" width={1280} height={864} />
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent" />
            <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
              <h3 className="text-xl font-bold mb-2">Our Commitment to Malaria Control</h3>
              <p className="text-sm text-white/80 leading-relaxed">
                Through global partnerships and local outreach, Marvid Pharmacy Limited distributes WHO-prequalified anti-malarial drugs to combat malaria in Uganda and across Africa.
              </p>
            </div>
          </div>
        </div>
